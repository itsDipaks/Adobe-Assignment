...
const PostCard = ({data, getPostListdata, no}) => {
  ...
  return (
    <div>
      <section className="text-gray-600 bg-gray-100 body-font overflow-hidden w-max m-4 rounded-4 border-gray-500">
        <div className=" px-5  mx-auto">
          <div className="">
            <div className="p-8 md:w-full  items-start">
              <h1 className="sm:text-xl text-xl font-medium text-gray-400 ">
                Sr.No. {no + 1}
              </h1>
              <h4 className="sm:text-2xl text-xl font-medium text-gray-900 mt-4 mb-4"></h4>
              <h1 className="leading-relaxed mb-8 font-medium w-96  text-gray-900 ">
                {data?.content}
              </h1>
